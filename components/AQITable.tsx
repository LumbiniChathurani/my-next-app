  ...
  return (
    <div className="p-4 flex justify-center bg-slate-100">
      <div className="w-full">
        ...
        <header style={{marginLeft:-220, marginRight:-220, borderBottom: "1px solid #e2e8f0", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, backgroundColor: "#ffffff", zIndex: 50, boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}>
